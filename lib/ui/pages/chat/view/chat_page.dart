...
class UserWidget extends StatefulWidget {
  final Stream<FirebaseDocumentHelper<List<Message>>> Function(DocumentSnapshot? doc) getUsers;
  const UserWidget({
    super.key,
...
class _UserWidgetState extends State<UserWidget> {
  late Stream<FirebaseDocumentHelper<List<Message>>> _userStream;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FirebaseDocumentHelper<List<Message>>>(
      stream: _userStream,
            ...
            itemBuilder: (context, index) {
              if (index < users.length) {
                ...
                return ListTile(
                  ...
                  subtitle: Text(user.content.toString()),
                  onTap: () {},
                );
              } else {
